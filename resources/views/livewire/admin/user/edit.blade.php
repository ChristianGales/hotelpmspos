...
<div>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="mb-6">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Update User Information</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Modify the user details below</p>
        </div>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <select id="user_type" name="user_type"
                        ...
                        <option value="admin" {{ old('user_type', $staff->user->user_type) == 'admin' ? 'selected' : '' }}>Admin</option>
                        <option value="cashier" {{ old('user_type', $staff->user->user_type) == 'cashier' ? 'selected' : '' }}>Cashier</option>
                    </select>
                    @error('user_type')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                    @enderror
